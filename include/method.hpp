...
class Method {
  public:
    ...
    {
        if (Il2cpp::get_method_param_count == nullptr)
            return -1;
    ...
    {
        if (Il2cpp::get_method_param_name == nullptr)
    ...
    {
        if (Il2cpp::get_method_param_type == nullptr)
    ...
    {
        if (Il2cpp::get_method_is_generic == nullptr)
            return false;
    ...
    {
        if (Il2cpp::get_method_is_inflated == nullptr)
            return false;
    ...
    {
        if (Il2cpp::get_method_is_instance == nullptr)
            return false;
